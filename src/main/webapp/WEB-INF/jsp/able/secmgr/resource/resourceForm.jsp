...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<!-- 리소스 생성 시작 -->
		<h3>리소스 생성</h3>
		<c:url value="/secmgr/resource/createResource.do" var="createResourceUrl"/>
		<form:form method="POST" action="${createResourceUrl}" commandName="resourceVO" >
			<!-- 생성 시작 -->
